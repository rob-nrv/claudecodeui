...
function ClaudePermissions({
  ...
  return (
    <div className="space-y-6">
      {/* Skip Permissions is intentionally not offered here: the Claude
          runtime (claude-runtime.provider.js) always refuses bypassPermissions
          mode server-side, so a client-side toggle for it would be dead. */}
